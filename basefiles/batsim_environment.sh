...
export PATH=$PATH:$prefix/charliecloud/charliecloud/bin:$basefiles_prefix:$basefiles_prefix/tests:$basefiles_prefix/debug_files:$prefix:$install_prefix/bin:/usr/bin:/usr/sbin
